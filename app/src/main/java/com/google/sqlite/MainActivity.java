...
import com.google.sqlite.Control.Database;
import com.google.sqlite.Model.Category;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (cursor.getCount()==0){
            ...
            db.insertCa("Category 4","Acer");
            db.insertCa("Category 5","Macbook");

        }
        cursor = db.GetData("select * from Computer");
        if (cursor.getCount()==0){
            db.insertC("PC01","Computer Asus 1","Category 1");
            db.insertC("PC02","Computer Lenovo 2","Category 2");
            db.insertC("PC03","Computer Dell 3","Category 3");
            db.insertC("PC04","Computer Acer 4","Category 4");
            db.insertC("PC05","Computer Macbook 5","Category 5");
        }
